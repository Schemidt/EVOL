...
//	static vector<double> vectorAvrAtk;//!<Массив для рассчета средней атаки
	...
	double cFD = 0.1;            // кроссфейд для "малых" агрегатов, в данном случае: закрылки, шасси - используется в Sound::play
...
public:
	...
	\return Статус источника OpenAL
	*/
	int play (bool status_on, bool status_off, /*bool status_max,*/ bool status_rev, bool status_hp, double parameter, Airplane &a);
};
