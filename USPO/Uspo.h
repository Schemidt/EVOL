...
struct SOUNDFFT {
	...
	bool p_eng_l_rev;           // признак реверса левого двиг. 0-1
	bool p_eng_r_rev;           // признак реверса правого двиг. 0-1
	...
	float obj_n;                // Обжатие носовой стойки шасси, 0..1
	float vyp_l;                // степень выпуска опоры левой (0...1)
	float vyp_r;                // степень выпуска опоры правой (0...1)
	float vyp_n;                // степень выпуска опоры носовой (0...1)
	float stv_l;                // степень открытия створки левой (0...1)
	float stv_r;                // степень открытия створки правой (0...1)
	float stv_n;                // степень открытия створки носовой (0...1)
	float flaps;                // степень выпуска/уборки закрылков (0...1)
	bool p_skv_on;              // Признак работы СКВ, 0-1
	bool p_ses1_on;             // признак работы СЭС левый борт, 0-1
	bool p_ses2_on;             // признак работы СЭС правый борт, 0-1
